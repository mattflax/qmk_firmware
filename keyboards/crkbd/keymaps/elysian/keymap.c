 ...
 */
  [_QWERTY] = LAYOUT_split_3x6_3(
    ...
    KC_LSFT, KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,      KC_N,    KC_M, KC_COMM,  KC_DOT, KC_SLSH, KC_SFTENT,
                   KC_LGUI,  MO(_LOWER),LT(_RAISE,KC_SPC),  LALT_T(KC_SPC),  MO(_RAISE), MO(_FUNCTION)
 ...
 */
  [_FUNCTION] = LAYOUT_split_3x6_3(
    ...
    _______, _______, _______, _______, _______, KC_F11,     KC_F12,  _______, _______, _______, _______, KC_INS,
    KC_CAPS, _______, _______, _______, _______, _______,    KC_MPLY, _______, KC_MPRV, KC_VOLD, KC_VOLU, KC_MNXT,
                               _______, _______, _______,    _______, _______, _______
  ),
