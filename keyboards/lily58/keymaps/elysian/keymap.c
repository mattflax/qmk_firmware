 ...
 * |      |   A  |   S  |   D  |   F  |   G  |-------.    ,-------|   H  |   J  |   K  |   L  |   ;  |      |
 * |------+------+------+------+------+------|   [   |    |    ]  |------+------+------+------+------+------|
 * |      |   Z  |   X  |   C  |   V  |   B  |-------|    |-------|   N  | Left | Down |  Up  | Right|      |
 * `-----------------------------------------/       /     \      \-----------------------------------------'
...
[_GAME] = LAYOUT( \
  ...
  KC_LSFT, KC_Z,   KC_X,    KC_C,    KC_V,    KC_B,    KC_LBRC, MO_QWRT, KC_N,    KC_LEFT,  KC_DOWN,KC_UP,   KC_RGHT, KC_ENT, \
...
[_MOUSE] = LAYOUT( \
  ...
  XXXXXXX, KC_LALT,	KC_LGUI, KC_LCTL, KC_LSFT, XXXXXXX,                   MS_LEFT, MS_DOWN, MS_UP,   MS_RGHT, XXXXXXX, XXXXXXX, \
  XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, KC_LBRC, KC_RBRC, KC_LEFT, KC_DOWN,	KC_UP,   KC_RGHT, XXXXXXX, XXXXXXX, \
                             KC_LALT, _______, L_NVSPC, L_MEDTB, MS_BTN2, MS_BTN1, MS_BTN3, MO(_FUNC) \
),
