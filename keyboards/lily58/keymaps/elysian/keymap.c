 ...
 * `-----------------------------------------/       /     \      \-----------------------------------------'
 *                   |LCtrl | LGUI |LOWER | /Space  /       \Space \  |RAISE | LAlt |  FN  |
 *                   |      |      |      |/       /         \      \ |      |      |      |
 *                   `----------------------------'           '------''--------------------'
 */
[_QWERTY] = LAYOUT( \
  ...
  KC_LSFT, KC_Z,   KC_X,    KC_C,    KC_V,    KC_B,    KC_LBRC, KC_RBRC, KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, KC_SFTENT, \
                            KC_LCTRL,KC_LGUI, LOWER,   KC_SPC,  KC_SPC,  RAISE,   KC_LALT, FN \
),
...
[_LOWER] = LAYOUT( \
 S(KC_GRV),_______, _______, _______, _______, _______,                   _______, _______, _______,_______, _______, KC_DEL,\
  _______, KC_EXLM, KC_DQUO, KC_HASH, KC_DLR,  KC_PERC,                   KC_CIRC, KC_AMPR, KC_ASTR, KC_LPRN, KC_RPRN, _______, \
  _______, _______, _______, _______, _______, _______,                   _______, KC_UNDS, KC_PLUS, KC_LBRC, KC_RBRC, _______, \
  KC_SLCK, KC_BSLS, _______, _______, _______, _______, KC_HOME, KC_END,  _______, KC_TILD, KC_PIPE, KC_LCBR, KC_INS, _______, \
...
[_RAISE] = LAYOUT( \
  ...
  _______, KC_PIPE, _______, _______, _______, _______, KC_PGDN, KC_PGUP, _______, KC_HASH, KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT, \
                             _______, _______, _______, _______, _______, _______, _______, _______ \
),
 ...
 * |ScrLck|      |      |      |      |      |-------|    |-------|      |      |      | Vol- | Vol+ | Mute |
 * `-----------------------------------------/       /     \      \-----------------------------------------'
 *                   |LCtrl | LGUI |LOWER | /Space  /       \Pause \  |RAISE | LAlt |ADJUST|
 *                   |      |      |      |/       /         \      \ |      |      |      |
 *                   `----------------------------'           '------''--------------------'
 */
[_FUNCTION] = LAYOUT( \
