...
[_LOWER] = LAYOUT( \
  ...
  KC_SLCK, KC_NUBS, _______, _______, _______, _______, KC_HOME, KC_END,  _______, KC_NUHS, _______, _______, KC_INS, _______, \
...
[_RAISE] = LAYOUT( \
 S(KC_GRV),_______, _______, _______, _______, _______,                   _______, _______, _______, _______, _______, KC_DEL, \
  ...
  _______,S(KC_NUBS),_______,_______, _______, _______, KC_PGDN, KC_PGUP, _______,S(KC_NUHS),KC_LEFT,KC_DOWN, KC_UP,   KC_RGHT, \
                             _______, _______, _______, _______, _______, _______, _______, _______ \
),
